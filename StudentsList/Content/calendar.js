...
document.write('<table id="fc" style="position:absolute;border-collapse:collapse;background:#E4E1D0;border:1px solid #F1F1F1;display:none;-moz-user-select:none;-khtml-user-select:none;user-select:none; width:250px; z-index:999; border-radius: 5px;" cellpadding="2">');
...
document.write('<tr style="background:#F1F1F1;font:12px Arial;color:#000000"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
...
function lcs(name) {
    ielem = document.getElementsByName(name)[0];
    updobj = ielem;
